# NetBoot Quill OS on the PineNote

0. Install `dropbear`, `wget` and `nbdkit` on your host PC.
...
2. Run the `serve.sh` script.
3. Get into your PineNote's U-Boot shell and enter:
```
...
4. Wait until you see a message like this on the console:
```
[2026-08-02T13:07:35Z INFO  libqinit::netboot] Waiting for NetBoot host; please connect USB cable
```
5. Plug your PineNote directly into your computer via USB cable.
6. Enjoy!
